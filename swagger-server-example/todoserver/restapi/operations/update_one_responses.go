...
func (o *UpdateOneOK) WithPayload(payload *models.Task) *UpdateOneOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update one o k response
func (o *UpdateOneOK) SetPayload(payload *models.Task) {
	o.Payload = payload
}
...
/*UpdateOneDefault could not update task
